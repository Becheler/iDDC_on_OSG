...
# Long duration
outSS <- read.delim("/home/becheler/dev/OSG_EGGS_CRUMBS/sumstats.txt")
outSS$X <- c()
head(outSS)

params <- read.csv("/home/becheler/dev/OSG_EGGS_CRUMBS/param_table.txt", sep="")
...
PARAM_S <- read.csv("/home/becheler/dev/OSG_EGGS_CRUMBS/param_table.txt", sep="")
# Remove constant values
PARAM_S$K_max. <- c()
PARAM_S$K_min. <- c()
head(PARAM_S)

STAT_S <- read.delim("/home/becheler/dev/OSG_EGGS_CRUMBS/sumstats.txt")
STAT_S$X <- c()
